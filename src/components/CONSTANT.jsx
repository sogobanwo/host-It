...
export const eventMainSidebarData = [
  {
    title: "Dashboard",
    icon: <HomeHashtag className="w-8 h-8 blue-text" />,
    url: "/events-dashboard",
  },
  {
    title: "Explore",
    icon: <CalendarSearch className="w-8 h-8 blue-text" />,
    url: "/all-events",
  },
  {
    title: "Create event",
    icon: <CalendarAdd className="w-8 h-8 blue-text" />,
    url: "/create-event",
  },
  {
    title: "Manage event",
    icon: <CalendarEdit className="w-8 h-8 blue-text" />,
    url: "/manage-events",
  },
  {
    title: "My Events",
    icon: <CalendarTick className="w-8 h-8 blue-text" />,
    url: "/my-events",
  },
   {
    title: "My collections",
    icon: <EthereumClassic className="w-8 h-8 blue-text" />,
    url: "/manage-event",
  }, {
    title: "My tickets",
    icon: <Ticket className="w-8 h-8 blue-text" />,
    url: "/manage-event",
  },
];
...
export const events = [
  {
    title: "Bragtime official App Launching by Rashotech Web services to check for the image layout if it is distorted or not. Thansk",
    timestamp: "2023-09-27T17:30:08.111Z",
    location: "1 Kent street , Melbourne",
    type: "free", //free/paid/private
    eventImage: "/images/single-event.png",
    attendees: {
      data: [
        {
  ...
  {
    title: "Bragtime official App Launching",
  ...
  },
  {
    ...
    attendees: {
      data: [
        {
          "image": `${image}?random=7`
        },
        {
          "image": `${image}?random=8`
        }
      ],
      total: 2
    },
  ...
  },
  {
    ...
    attendees: {
      data: [
        ...
        {
          "image": `${image}?random=10`
        },
        {
          "image": `${image}?random=11`
        }
      ],
      total: 40
    },
  ...
  },
  {
    ...
    attendees: {
      data: [
        {
          "image": `${image}?random=12`
        },
        {
          "image": `${image}?random=13`
        },
        {
          "image": `${image}?random=14`
        }
      ],
      total: 30
    },
  ...
  },
  {
    ...
    attendees: {
      data: [
        {
          "image": `${image}?random=15`
        },
        {
          "image": `${image}?random=16`
        },
        {
          "image": `${image}?random=16`
        }
