...
export const eventMainSidebarData = [
  {
    title: "Dashboard",
    icon: <HomeHashtag className="w-8 h-8 text-primaryColor" />,
    url: "/events-dashboard",
  },
  {
    title: "Explore",
    icon: <CalendarSearch className="w-8 h-8 text-primaryColor" />,
    url: "/all-events",
  },
  {
    title: "Create event",
    icon: <CalendarAdd className="w-8 h-8 text-primaryColor" />,
    url: "/create-event",
  },
  {
    title: "Manage event",
    icon: <CalendarEdit className="w-8 h-8 text-primaryColor" />,
    url: "/manage-events",
  },
  {
    title: "My Events",
    icon: <CalendarTick className="w-8 h-8 text-primaryColor" />,
    url: "/my-events",
  },
   {
    title: "My collections",
    icon: <EthereumClassic className="w-8 h-8 text-primaryColor" />,
    url: "/my-collections",
  }, {
    title: "My tickets",
    icon: <Ticket className="w-8 h-8 text-primaryColor" />,
    url: "/my-tickets",
  },
];
